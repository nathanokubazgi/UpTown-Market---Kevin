...
export const Route = createFileRoute("/order")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Order from Uptown Fresh Market Nashville online. Available on UberEats, DoorDash, GrubHub, and Postmates for delivery or pickup." },
      { property: "og:title", content: "Order Online — Uptown Fresh Market" },
      { property: "og:description", content: "Order for delivery or pickup via UberEats, DoorDash, GrubHub & more." },
    ],
  }),
  component: OrderPage,
});
...
const platforms = [
  ...
  { name: "DoorDash", color: "bg-[#FF3008]", textColor: "text-[#ffffff]", url: "https://www.doordash.com", description: "DashPass eligible, quick delivery" },

        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="mt-4 flex gap-3">
              ...
              <a href="https://www.instagram.com/uptownfreshmarket/?hl=en" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="rounded-md p-2 text-muted-foreground transition-colors hover:bg-accent hover:text-foreground">

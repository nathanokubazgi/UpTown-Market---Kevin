        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="mt-4 flex gap-3">
              <a href="https://www.facebook.com/uptownfreshmarket/" target="_top" rel="noopener noreferrer" aria-label="Facebook" className="rounded-md p-2 text-muted-foreground transition-colors hover:bg-accent hover:text-foreground">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.instagram.com/uptownfreshmarket/?hl=en" target="_top" rel="noopener noreferrer" aria-label="Instagram" className="rounded-md p-2 text-muted-foreground transition-colors hover:bg-accent hover:text-foreground">
              ...
              <a href="https://www.yelp.com/biz/uptown-fresh-market-antioch" target="_top" rel="noopener noreferrer" aria-label="Yelp" className="rounded-md p-2 text-muted-foreground transition-colors hover:bg-accent hover:text-foreground">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex gap-2">
                ...
                <span>Mon–Thu: 5:30AM–10PM<br />Fri–Sat: 5:30AM–11PM<br />Sun: 6:30AM–11PM</span>
              </li>
            </ul>
          </div>
